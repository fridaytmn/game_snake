...
# Константы
WINDOWS_SIZE = WINDOW_WIDTH, WINDOW_HEIGHT = (400,400)
OBJECT_SIZE = 10
...
dx, dy = 0, 0
fps = 7
apple = randrange(0, WINDOW_WIDTH, OBJECT_SIZE), randrange(0,
WINDOW_HEIGHT, OBJECT_SIZE)
# Словать движения
...
while True:
    ...
    # Количество раз выполнения циклов в секунду
    clock.tick(2*fps)
